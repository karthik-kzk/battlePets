  ...
  return (
    <div className="App">
      ...
      {/* <BoostrapModel buttonName='Next' message="work in progress" />   */}
       ...
       {data[state].battleReady&& <BattleDetailCard characterName={data[state].characterName} attackName={attackName} className={`battleDetailCard ${enemyScore%2==0&&'horizontal-shake'} `} />}
      </div>      
    </div>
  );
}
